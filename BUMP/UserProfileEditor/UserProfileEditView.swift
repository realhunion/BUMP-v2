...
public class UserProfileEditView : UIView {
    ...
    lazy var userHandleTextField : UITextField = {
        ...
        textfield.attributedPlaceholder = NSAttributedString(string: self.handlePlaceholder, attributes: [NSAttributedString.Key.foregroundColor: Constant.textfieldPlaceholderGray])
